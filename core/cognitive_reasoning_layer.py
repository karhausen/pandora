    ...
    def reason(
        ...
        *,
        ...
        system_prompt = (
            ...
            "If the user appears to ask for a reusable persistent Pandora capability, and no existing capability is sufficient, choose create_tool_proposal. "
            ...
            "If the user's wording is ambiguous between one-time help and installing a persistent capability, choose clarify. "
            "Schema: {action:string, route:string, confidence:number, user_goal:string, reason:string, "
            "existing_capability_sufficient:boolean, new_capability_required:boolean, "

...
def run_tests(dst: Path) -> None:
    subprocess.run([sys.executable, "-m", "pytest", "tests/test_mvp21_1_1_release_packaging.py", "tests/test_mvp21_2_maintenance_manager.py", "tests/test_mvp21_3_skill_candidate_pipeline.py", "tests/test_mvp21_4_tool_improvement_pipeline.py", "tests/test_mvp21_5_capability_gap_pipeline.py", "tests/test_mvp21_6_proposal_review_inbox.py", "tests/test_mvp21_7_proposal_approval_workflow.py", "tests/test_mvp21_8_gui_approval_api.py", "tests/test_mvp21_9_minimal_web_gui.py", "tests/test_mvp22_0_operations_dashboard.py", "tests/test_mvp22_1_user_gui_navigation.py", "tests/test_mvp22_2_tool_center_gui.py", "-q"], cwd=dst, check=True)
...
def main() -> int:
    ...
    parser.add_argument("--version", default="mvp-22.2-tool-center-gui")

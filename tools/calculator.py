...
TOOL_META={"id":"calculator","name":"Calculator","description":"Safely evaluates simple arithmetic expressions.","version":"0.1.0","input_schema":{"expression":"str"},"output_schema":{"result":"number"},"security_level":"SAFE","status":"ACTIVE","module":"tools.calculator","function":"run"}

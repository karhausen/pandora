...
class CognitiveContextBuilder:
    ...
    def build_for_chat(self, query: str, *, provider_name: str | None = None, model: str | None = None, limit: int | None = None) -> dict[str, Any]:
        ...
        orchestration_plan = self.python_orchestrator.plan(query, analysis=capability_analysis, provider_name=provider_name, model=model)
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "pipeline": ["request_interpretation", "capability_analysis", "python_orchestration", "collect_candidates", "rank", "duplicate_removal", "budget", "prompt_context"],
